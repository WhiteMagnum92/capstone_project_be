...
public class Nano implements Razza {
	...
	public void applicaCambiamenti(Personaggio p) {
		// settaggio degli aumenti di caratteristica
					...
					Privilegio p2 = new Privilegio("Resilienza Nanica", "Vantaggio ai TS veleno e di resistenza ai danni da veleno");
					Privilegio p3 = new Privilegio("Addestramento da Combattimento Nanico", "Compentenza in asce, asce da battaglia, martelli da guerra e martelli leggeri");
					Privilegio p4 = new Privilegio("Competenza negli strumenti", "Compentenza in un gruppo di strumenti da artigiano a sua scelta");
					Privilegio p5 = new Privilegio("Esperto Minatore", "Ognivolta che un nano effetua una prova di intelligenza (Storia) relativa all'origine di una struttura in pietra, aggiunge il doppio del suo bonus di competenza");
